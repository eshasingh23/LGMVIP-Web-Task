...
function data(){
    ...
    if(element[7].checked){skills.innerHTML="SKILLS: Javascript";}
    if(element[5].checked && element[6].checked){skills.innerHTML="SKILLS: HTML, CSS ";}
    if(element[5].checked && element[7].checked){skills.innerHTML="SKILLS: HTML, Javascript";}
    if(element[6].checked && element[7].checked){skills.innerHTML="SKILLS: CSS, Javascript";}
    if(element[5].checked && element[6].checked && element[7].checked){skills.innerHTML="SKILLS: HTML, CSS, Javascript";}
